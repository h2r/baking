...
public class MoltenLavaCake extends Recipe {
	...
	public MoltenLavaCake() {
		...
		IngredientRecipe melted = new IngredientRecipe("melted_stuff", NOTMIXED, NOTMELTED, NOTBAKED, SWAPPED, ingredientList);
		
		List<IngredientRecipe> ingredientList2 = new ArrayList<IngredientRecipe>();
		ingredientList2.add(melted);
		IngredientRecipe batter = new IngredientRecipe("batter", NOTMIXED, NOTMELTED, NOTBAKED, SWAPPED, ingredientList2);
		batter.addNecessaryTrait("flour", NOTMIXED, NOTMELTED, NOTBAKED);
		batter.addNecessaryTrait("sugar", NOTMIXED, NOTMELTED, NOTBAKED);
		...
		IngredientRecipe unflavored_batter = new IngredientRecipe("unflavored_batter", NOTMIXED, NOTMELTED, NOTBAKED, SWAPPED, ingredientList3);
		...
		this.topLevelIngredient = new IngredientRecipe("molten_lava_cake", NOTMIXED, NOTMELTED, NOTBAKED, ingredientList4);
