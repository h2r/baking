...
java -Xms1g -Xmx4g -cp ~/workspace/baking/h2r-baking.jar edu.brown.cs.h2r.baking.Experiments.ManyAgentsSchedulingSubgoals $SGE_TASK_ID 2>"$ERR_DIRECTORY/$SGE_TASK_ID.err" 1> "$DIRECTORY/$SGE_TASK_ID.csv"
